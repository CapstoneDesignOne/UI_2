...
class poseChoice_posePractive extends StatefulWidget {
  final changeView; // practice = num
  const poseChoice_posePractive(this.changeView, {Key? key}) : super(key: key);

  @override
  _poseChoice_posePractiveState createState() =>
      _poseChoice_posePractiveState();
}

class _poseChoice_posePractiveState extends State<poseChoice_posePractive> {
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              Column(
                                children: [
                                  Image.asset(selectedImages[i]),
                                  Text(
                                    selectedPoseName[selectedPoses_int[i]],
                                    textAlign: TextAlign.center,
                                  ),
                                  ElevatedButton(
                                    onPressed: () {
