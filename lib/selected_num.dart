...
class selected_pose_num with ChangeNotifier {
  ...
  List<String> _selectedPoseNameSever = []; //선택된 포즈 이름
  // 외부에서 접근 할 수 있도록 getter 생성
  List<String> get selectedPoseNameSever =>_selectedPoseNameSever;
  ...
  void removeSelectedPose(int i) {
    ...
    _selectedPoseNameSever.removeAt(i);
    notifyListeners();
  }
